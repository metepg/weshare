...
ALTER TABLE ${schema}.users RENAME COLUMN username TO name;

-- Add the group_id column to users table
ALTER TABLE ${schema}.users ADD COLUMN group_id UUID;
...
DO $$
    ...
    BEGIN
        ...
        UPDATE ${schema}.users SET group_id = group_uuid;
    END $$;

-- Ensure group_id column is not null
ALTER TABLE ${schema}.users ALTER COLUMN group_id SET NOT NULL;
