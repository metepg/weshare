...
class UserRepositoryTest {
    ...
    void testUniqueUserNameAcrossDifferentGroups() {
        Group anotherGroup = groupRepository.save(MockDataProvider.createMockGroup());
        User userInAnotherGroup = MockDataProvider.createMockUser(anotherGroup);
        ...
        assertThat(foundUser).isPresent();
        assertThat(foundUser.get().getName()).isEqualTo(testUser.getName());
        assertThat(foundUser.get().getGroup().getId()).isEqualTo(anotherGroup.getId());
    }
}